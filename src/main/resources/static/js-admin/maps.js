...
var map = AmCharts.makeChart("mapamchart6", {
    ...
    /**
     * Data Provider
     * The images-admin contains pie chart information
...
function updateCustomMarkers(event) {
    ...
    // go through all of the images-admin
...
// this function will take current images-admin on the map and create HTML elements for them
function updateCustomMarkers(event) {
    // get map object
    var map = event.chart;
